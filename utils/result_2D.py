...
if __name__ == '__main__':
    ...
    fault_path = r"E:\conda\jupyter_notebook\ResACEUnet-master\fault_detection\datasets\test\fault\Seismic_LightEGEUnet.npy"
    seismic(seismic_path,0,2)
    fault(seismic_path,fault_path,0,2)
